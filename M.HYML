      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
           <div align='left' class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">CHECKER FULL</h3>
          </div>
        </div>
...
<a class="btn btn-try-builder btn-bg-gradient-x-purple-red btn-glow white" href="" target="_blank"><i class="ft-airplay"></i> Api by Marco</a>
